...
(function() {
  $(function() {
    return $(document).on("turbolinks:load", function() {
      ...
      return $('[type="file"]').on('change', function(event) {
        var files;
        ...
        return $.each(files, function(index, value) {
          ...
          reader.onload = function(file) {
            ...
            return $('fieldset.upload').css('display', 'inline-block').append(img);
          };
  ...
  $(function() {
    ...
    $(document).on("click", ".category", function(e) {
      ...
      if ($(".parent").hasClass("active")) {
        return $(".child[data-category-id='" + id + "']").slideDown();
      }
    });
    ...
    $(document).on("click", ".product-image", function(e) {
      ...
      src[index] = "large";
      src_large = src.join("/");
      return $(".main-product-image img").attr("src", src_large);
    });
    $(document).on("change", "#product_category_category", function(e) {
      e.preventDefault();
    ...
    return $(document).on("change", "#product_sub_category_id", function(e) {
      e.preventDefault();
      return $.ajax({
        type: "GET",
        url: "/products/new",
